...
const BagianHero = () => {
  return (
    // Bagian Hero
    <header id="beranda" className="bg-hero text-white px-[5%] pt-14 md:pt-10 lg:pt-10 pb-10 flex flex-col-reverse md:flex-row items-center gap-6 md:gap-10 lg:gap-16 xl:min-h-[85vh] overflow-hidden">
